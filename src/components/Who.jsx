...
const Who = () => {
    ...
    return (
        <div className="text-center w-full my-20 mx-auto" id="soluciones" data-aos="fade-down">
            ...
            <div className="flex gap-2 md:gap-5 justify-center md:flex-row font-dm_sans">
                {/* Button 1 */}
                <button
                    ...
                    {activeButton === 1 && (
                        <>
                            ...
                            <div className='w-full md:w-[20rem] lg:w-[18rem]'>
                                ...
                                <p className='text-base text-start my-2 font-dm_sans'>Busca y encuentra transacciones en segundos, descárgalos en excel o envíalos directamente a tu gestor.</p>
                            </div>
                            ...
                            <div className='w-full md:w-[20rem] lg:w-[18rem]'>
                                ...
                                <p className='text-base text-start my-2 font-dm_sans'>Envía las facturas directamente a Banktrack y digitalízalos en el momento con inteligencia artificial</p>
                            </div>
                            ...
                            <div className='w-full md:w-[20rem] lg:w-[18rem]'>
                                ...
                                <p className='text-base text-start my-2 font-dm_sans'>Crea reglas para categorizar o modificar automáticamente las transacciones de tus cuentas.</p>
                            </div>
                            ...
                            <div className='w-full md:w-[20rem] lg:w-[18rem]'>
                                ...
                                <p className='text-base text-start my-2 font-dm_sans'>Crea informes diarios, mensuales o trimestrales y recíbelos por email, WhatsApp, Slack o Telegram.</p>
                            </div>
                            ...
                            <div className='w-full md:w-[20rem] lg:w-[18rem]'>
                                ...
                                <p className='text-base text-start my-2 font-dm_sans'>Recibe alertas cuando pasa algo en tus cuentas: Ingresos, Gastos, Cargos duplicados, Saldo bajo etc.</p>
                            </div>
                            ...
                            <div className='w-full md:w-[20rem] lg:w-[18rem]'>
                                ...
                                <p className='text-base font-dm_sans text-start my-2'>Crea reglas para categorizar o modificar automáticamente las transacciones de tus cuentas.</p>
                            </div>
                        </>
                    )}
