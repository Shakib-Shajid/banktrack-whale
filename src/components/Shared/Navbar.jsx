    ...
    return (
        <div className={`${dmSans.className} font-medium`}>
            <div className={`navbar z-50 fixed ${isScrolled ? 'bg-white shadow-md' : 'bg-transparent'}`}>
                <div className="navbar-start md:pl-10 custom-1080:pl-2 xl:ml-20"> {/*   */}
                    ...
                    <div className="navbar-center hidden lg:flex custom-1080:pl-7 xl:pl-20">
                ...
                <div className="navbar-end md:justify-center lg:justify-end w-[50%] md:pr-2 custom-1080:pr-0 xl:pr-24"> {/**/}
