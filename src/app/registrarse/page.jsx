                ...
                <div className='md:w-[80%] mx-auto lg:w-[70%] flex justify-center text-center pt-10'>
                    ...
                    <div className="flex flex-col border-opacity-50" >
                        ...
                        <div className='space-y-3 w-[90%] md:w-full mx-auto'>
                            <input type="email" placeholder="Tu correo electrónico" className="input input-bordered w-full lg:w-full " />
                            <input type="password" placeholder="Contraseña" className="input input-bordered w-full lg:w-full" />
                            <div className='py-5'>
